...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        for i in range(block_config[0]):
            ...
            gate = FeedforwardGateII(pool_size = 56, channel = num_features + (i + 1) * growth_rate, out_channels = growth_rate)
        ...
        for i in range(block_config[1]):
            ...
            gate = FeedforwardGateII(pool_size = 28, channel = num_features + (i + 1) * growth_rate, out_channels = growth_rate)
        ...
        for i in range(block_config[2]):
            ...
            gate = FeedforwardGateII(pool_size = 14, channel = num_features + (i + 1) * growth_rate, out_channels = growth_rate)
        ...
        for i in range(block_config[3]):
            ...
            gate = FeedforwardGateII(pool_size = 7, channel = num_features + (i + 1) * growth_rate, out_channels = growth_rate)
