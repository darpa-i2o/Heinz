...
import logging
import models_channel_skip
import numpy as np
from functools import reduce

model_names = sorted(name for name in models_channel_skip.__dict__
                     if name.islower() and not name.startswith("__")
                     and callable(models_channel_skip.__dict__[name]))
...
def run_training(args):
    # create model
    model = models_channel_skip.__dict__[args.arch](args.pretrained)
